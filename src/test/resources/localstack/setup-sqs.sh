...
# FUTURE - court-case-events SNS is notified with the message which is passed on to court-case-matcher-queue
...
# LEGACY - court-case-matcher reads XML from the crime-portal-gateway-queue
aws --endpoint-url=http://localhost:4566 sqs create-queue --queue-name crime-portal-gateway-dlq
