...
public class SqsMessagingConfig {
    ...
    public AmazonSQSAsync courtCaseMatcherSqsDlq(@Value("${aws.region-name}") final String regionName,
                                                 @Value("${aws_sqs_court_case_matcher_dlq_endpoint_url}") final String awsEndpointUrl,
                                                 @Value("${aws_sqs_court_case_matcher_dlq_access_key_id}") final String awsAccessKeyId,
                                                 @Value("${aws_sqs_court_case_matcher_dlq_secret_access_key}") final String awsSecretAccessKey) {
        return getAmazonSQSAsync(awsAccessKeyId, awsSecretAccessKey, awsEndpointUrl, regionName);
    }
    ...
    @Primary
    @Bean
    public SqsService sqsService(AmazonSQSAsync courtCaseMatcherSqsQueue, @Value("${aws_sqs_court_case_matcher_queue_name}") String queueName) {
